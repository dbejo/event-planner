...
public class EventPlannerApplication {
    ...
    CommandLineRunner run(OrganizationRepository organizationRepository, PersonRepository personRepository, EventRepository eventRepository) {
        return args -> {
            ...
            personRepository.save(new Person(null, "Giga", "Chad", "Top CEO", "email1@email.com", true, Set.of(new Organization(1, null, null, null, null, null, null)), null));
            personRepository.save(new Person(null, "Komoly", "Janos", "Nem komoly", "email2@email.com", true, Set.of(new Organization(1, null, null, null, null, null, null)), null));
            personRepository.save(new Person(null, "Kis", "Juliska", "Kis titkarno", "email3@email.com", true, Set.of(new Organization(2, null, null, null, null, null, null)), null));
            personRepository.save(new Person(null, "Nagy", "Marcsi", "Nagy titkarno", "email4@email.com", true, Set.of(new Organization(3, null, null, null, null, null, null)), null));
            personRepository.save(new Person(null, "Takker", "Neni1", "Top level takaritoneni", "email5@email.com", true, Set.of(new Organization(4, null, null, null, null, null, null)), null));
            personRepository.save(new Person(null, "Takker", "Neni2", "Gyakornok takker neni", "email6@email.com", true, Set.of(new Organization(4, null, null, null, null, null, null)), null));

            eventRepository.save(new Event(null, "Kajalas a fonivel", "Lesz sok kaja gyertek", "McDonalds", Date.valueOf(LocalDate.now()), true,
                    Set.of(new Person(1, null, null, null, null, null, null, null),
            ...
            eventRepository.save(new Event(null, "Takker buli", "Koszosan gyertek", "3. emelet", Date.valueOf(LocalDate.now()), true,
                    Set.of(new Person(5, null, null, null, null, null, null, null),
